...
def calc_rho(high_eval, low_eval, cos=True):
...
def main():
    ...
    with mpl.rc_context(params):
        ...
        dffuncs.to_csv("svrgcosfunc.csv", index=False)
        dflosses.to_csv("svrgcoslosses.csv", index=False)
        dfolosses.to_csv("svrgcosolosses.csv", index=False)
